  ...
  return (
    ...
    >
      <TableCell padding="none">
        <Link to={`/projects/${spent.project_key}`} className="link">
          {spent.project_name}
        </Link>
      </TableCell>
      ...
      <TableCell padding="none">
        <Link
          to={`/projects/${spent.project_key}/members/${spent.user_id}`}
          className="link"
        >
          {spent.user_name}
        </Link>
      ...
      <TableCell padding="none">
        <Link
          className="link"
          to={`/projects/${spent.project_key}/issues/${spent.issue_id}`}
        >
          {spent.issue_subject}
        </Link>
      </TableCell>
        ...
        {canEdit && (
          <>
            <IconButton
              color="success"
              LinkComponent={Link}
              to={`/projects/${spent.project_key}/spents/${spent.id}`}
            >
              <IconEdit />
            </IconButton>
